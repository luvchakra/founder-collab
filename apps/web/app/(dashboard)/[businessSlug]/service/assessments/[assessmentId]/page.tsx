...
export default async function AssessmentDetailPage({ params }: { params: Promise<{ businessSlug: string; assessmentId: string }> }) {
  const { businessSlug, assessmentId } = await params;
