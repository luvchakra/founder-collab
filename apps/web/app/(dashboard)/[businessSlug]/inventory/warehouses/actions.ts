...
async function warehousesPath(businessId: string) {
  return `${await businessPath(businessId)}/inventory/warehouses`;
}
...
export async function createWarehouseAction(
  ...
  revalidatePath(await warehousesPath(businessId));
  return { success: true };
}
