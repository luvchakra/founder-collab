...
/** BRAND-07: "CRM | WonderArk" in the browser tab. Absolute, with the template
 * re-declared: a plain title here would stop the root "%s | WonderArk" template from
 * reaching the pages below. */
export const metadata: Metadata = { title: { absolute: `CRM | ${BRAND_NAME}`, template: BRAND_TITLE_TEMPLATE } };
