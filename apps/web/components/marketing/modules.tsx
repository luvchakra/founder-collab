...
const MODULES: {
  ...
  {
    name: "Discovery",
    tagline: "Find customers, market to them, and fund the growth",
    body: "Per business offering, AI builds your ideal customer profile, finds and scores real accounts, and explains why each is worth a conversation now. Marketing and Funding sit alongside, on the same data.",
    features: [
      "Ideal customer profiles and scored prospects, per offering",
      "Marketing: strategy, campaigns, AI content, SEO and analytics",
      "Funding: investor pipeline, readiness, data room and diligence",
  ...
  {
    name: "Finance",
    tagline: "Accounting and GST from the sales you already recorded",
    body: "Invoices, bills, payments and expenses post themselves to a double-entry ledger, and statements, bank reconciliation, e-invoices and GST returns are built from the same records Inventory and Service already created.",
    features: [
      "Invoices, bills and payments post to the ledger automatically",
      "P&L, balance sheet and cash flow, drill down to every entry",
