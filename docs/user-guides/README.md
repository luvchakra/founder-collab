...
- **[00 — Getting Started](./00-getting-started.md)** — signing up, creating
  ...
  modules, team & permissions, API keys, and the environment variables an
  operator needs to configure before go-live.
...
- **[01 — Discovery](./01-discovery.md)** — customer acquisition, ICPs,
  AI-powered prospecting, and opportunity intelligence.
