...
async function main() {
  await withTestDatabase({
    ...
    testFn: async ({ psql, psqlAs, assertEqual, assertThrows }) => {
      ...
      console.log("Carol (accountant, no settings.manage) CAN record a reminder sent -- this table's INSERT needs a Finance write permission (RBAC-39), not a settings action...");
